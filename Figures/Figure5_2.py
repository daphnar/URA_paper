...
def_data= pd.read_csv(os.path.join(FIGURES_DIR, 'Figures - il_sub_vs_us_sgb_pvals.csv'))
...
plt.savefig(os.path.join(FIGURES_DIR, 'figure5_sub.pdf'), bbox_inches='tight', format='pdf')
plt.savefig(os.path.join(FIGURES_DIR, 'figure5_sub.png'), bbox_inches='tight', format='png')
