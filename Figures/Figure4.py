...
colors_rgb_age = colors_rgb
colors_rgb_bmi_hba1c = colors_rgb
...
axdrest_grid = gridspec.GridSpecFromSubplotSpec(2,3, rest_grid[1,0], hspace=0.7,wspace=0.7,
                                                width_ratios=[1./3,1./3,1./3])

ax__age_scatter = plt.subplot(axdrest_grid[0,0])
ax__age_saturation = plt.subplot(axdrest_grid[1,0])
ax__hba1c_scatter = plt.subplot(axdrest_grid[0,1])
ax__hba1c_saturation = plt.subplot(axdrest_grid[1,1])
ax__bmi_scatter = plt.subplot(axdrest_grid[0,2])
ax__bmi_saturation = plt.subplot(axdrest_grid[1,2])
...
ind = range(len(phenotypes))
# orderAge=[u'CV(Train-IL): age+gender',
#           u'CV(Train-IL): microbiome',u'Test1-IL: microbiome',u'Test2-US: microbiome',
#           u'CV(Train-IL): age+gender+microbiome'][::-1]
# orderBMI_HbA1C=[u'CV(Train-IL): microbiome',u'CV(Train-IL): age+gender',
#  u'CV(Train-IL): age+gender+microbiome',u'Test1-IL: age+gender+microbiome',u'Test2-US: age+gender+microbiome'][::-1]
#
# order=[u'CV(Train-IL): microbiome',u'Test1-IL: microbiome',u'Test2-US: microbiome',u'CV(Train-IL): age+gender',
#  u'CV(Train-IL): age+gender+microbiome',u'Test1-IL: age+gender+microbiome',u'Test2-US: age+gender+microbiome'][::-1]

# orderAge=[u'Test1-IL: microbiome',u'Test2-US: microbiome'][::-1]
...
#                               zorder=1,#edgecolor='none',
#                               color='white',#color=colors_rgb_age,
#                               edgecolor=colors_rgb_age,
#                               legend=False,
#                               width=0.8)
onlyage_prediction.plot.barh(xerr=onlyage_err,ax = axc__hba1c_bmi_bar,
                              zorder=1,edgecolor='none',
...
#                               zorder=1,#edgecolor='none',
#                               color='white',
#                               edgecolor=colors_rgb_bmi_hba1c,
#                               legend=False,
#                               width=0.8)
noage_prediction.plot.barh(xerr=noage_err,ax = axc__hba1c_bmi_bar,
                              zorder=1,edgecolor='none',
...
# hatches = patterns_age+patterns_rgb_bmi_hba1c
...
ax__age_scatter.annotate('$R^{2}$=%.2f'%r_square,(12,78),fontsize=8)
...
plt.text(-0.6, 1.1, 'g', ha='center', va='center', transform=ax__age_saturation.transAxes, fontsize=16)
saturation_df=pd.read_csv(os.path.join(FIGURES_DIR,'Figures - age_saturation.csv'))
...
ax__age_saturation.set_xticks([0,5000,10000])
...
r_square=r2_score(x,y)
ax__hba1c_scatter.annotate('$R^{2}$=%.2f'%r_square,(2.2,7.8),fontsize=8)
...
r_square=r2_score(x,y)
ax__bmi_scatter.annotate('$R^{2}$=%.2f'%r_square,(10.5,35),fontsize=8)
...
plt.text(-0.3, 1.1, 'h', ha='center', va='center', transform=ax__hba1c_saturation.transAxes, fontsize=16)
saturation_df=pd.read_csv(os.path.join(FIGURES_DIR,'Figures - hba1c_saturation.csv'))
saturation_df.sort_values(by='cohort_size',inplace=True)
saturation_df.loc[:,['mean_pearson','mean_std']] = saturation_df.loc[:,['mean_pearson','mean_std']].mul(100)
...
ax__hba1c_saturation.set_xticks([0,4000,8000])
plt.ylim(0,22)
ax__hba1c_saturation.set_yticks([0,5,10,15,20])
plt.xlabel('Sample size')
plt.ylabel('HbA1C% $R^{2}$ (%)')

plt.sca(ax__bmi_saturation)
plt.text(-.28, 1.1, 'i', ha='center', va='center', transform=ax__bmi_saturation.transAxes, fontsize=16)
saturation_df=pd.read_csv(os.path.join(FIGURES_DIR,'Figures - bmi_saturation.csv'))
saturation_df.sort_values(by='cohort_size',inplace=True)
saturation_df.loc[:,['mean_pearson','mean_std']] = saturation_df.loc[:,['mean_pearson','mean_std']].mul(100)
...
ax__bmi_saturation.set_xticks([0,5000,10000])
plt.xlabel('Sample size')
# plt.ylabel('')
plt.ylabel('BMI $R^{2}$ (%)')
plt.ylim(0,20)
