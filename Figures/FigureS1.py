...
plt.xticks(ind,phenotypes.index,rotation=45,ha='right')
axd__binary_phenotypes.tick_params(top='off',right='off',pad=0,labelsize=fontsize)
axd__binary_phenotypes.yaxis.set_ticks_position('left')
axd__binary_phenotypes.xaxis.set_ticks_position('bottom')
sns.despine(ax=axd__binary_phenotypes)
plt.ylabel('AUC')
plt.xlabel('')
plt.ylim(0.5,1)
