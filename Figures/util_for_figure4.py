...
def merger(pheno):
    obj1 = pd.read_csv('saturation_xgboostMB_%s_vs_US.csv'%pheno)
    obj2 = pd.read_csv('saturation_RidgeMB_%s_vs_US.csv'%pheno)
    ...
    merged.to_csv('Figures - %s_saturation_US.csv'%pheno)
